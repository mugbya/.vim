...
hi Normal       guifg=#A9B7C6 guibg=#2B2B2B ctermfg=7 ctermbg=0
...
" hi LineNr       guifg=#75715E guibg=#1c1c1c gui=none ctermfg=8 ctermbg=9 cterm=none
highlight LineNr guifg=#444444 guibg=#242424 gui=none ctermfg=8 ctermbg=9 cterm=none  " 行号颜色 
...
hi Pmenu        guifg=fg guibg=#1c1c1c ctermfg=fg ctermbg=9     " modify
...
" hi StatusLine   guifg=fg guibg=#3E3D32 gui=none ctermfg=fg ctermbg=9 cterm=none         " 默认
hi StatusLine   guifg=fg guibg=#1c1c1c gui=none ctermfg=fg ctermbg=9 cterm=none           " modify
hi StatusLineNC guifg=#75715E guibg=#1c1c1c gui=none ctermfg=8 ctermbg=9 cterm=none
hi TabLine      guifg=#75715E guibg=#1c1c1c gui=none ctermfg=8 ctermbg=9 cterm=none
hi TabLineFill  guifg=fg guibg=#1c1c1c gui=none ctermfg=fg ctermbg=9 cterm=none
hi TabLineSel   guifg=fg guibg=#1c1c1c gui=none ctermfg=fg ctermbg=9 cterm=none
...
" hi MyTagListFileName guifg=#000000 guibg=bg gui=none ctermfg=11 ctermbg=bg cterm=none
